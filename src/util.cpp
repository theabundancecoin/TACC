...
const char * const PIVX_CONF_FILENAME = "tacccoin.conf";
const char * const PIVX_PID_FILENAME = "tacccoin.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "TaccCoin";
#else
    fs::path pathRet;
...
void ArgsManager::ReadConfigFile()
{
    ...
    if (!streamConfig.good()) {
        // Create empty tacccoin.conf if it does not exist
