...
public:
    CMainParams()
    {
        ...
        genesis = CreateGenesisBlock(1625665763, 2913765, 504365040, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();

        assert(consensus.hashGenesisBlock == uint256S("0000081e26274b02051ccb85bcb36216ca73c639b9eb2f5ee421d67a996c8e50"));
        assert(genesis.hashMerkleRoot == uint256S("f5239467dd2a9dd0fce7a3babc03c7985eab2229c62e3d5670375f305753c9cc"));
        ...
        consensus.strSporkPubKey = "0438b26f11f1ef3fd08af69cc6c78b91ade65c2aae9e3d111b57acaf7721c28fbe39349d1b3589f57f6618d0c006fc5f3beb9be1d1775d18d019da909f2e56fe06";
        consensus.strSporkPubKeyOld = "0438b26f11f1ef3fd08af69cc6c78b91ade65c2aae9e3d111b57acaf7721c28fbe39349d1b3589f57f6618d0c006fc5f3beb9be1d1775d18d019da909f2e56fe06";
...
//        consensus.nPivxBadBlockBits = 0x1c056dac;    // Skip nBit validation of Block 259201 per PR #915
        ...
        consensus.ZC_TimeStart = 0;        // October 17, 2017 4:30:00 AM
        ...
        consensus.vUpgrades[Consensus::UPGRADE_ZC].nActivationHeight            = 168624000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_V2].nActivationHeight         = 168624000;
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 180863000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 168624000;
        ...
        vSeeds.push_back(CDNSSeedData("s1.theabundancecoin.com", "seeder1.theabundancecoin.com"));         // Single node address
...
public:
    CTestNetParams()
    {
        ...
        genesis = CreateGenesisBlock(1625896070, 1225967, 504365040, 1, 250 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
      ...
      //  assert(consensus.hashGenesisBlock == uint256S("0000057f2e15761f4a12d7cab16e046130666fd738dbd830cf0786d2e8fa94a71f757"));
       // assert(genesis.hashMerkleRoot == uint256S("0x1b2ef6e2f28be914103a277377ae7729dcd125dfeb8bf97bd5964ba72b6dc39b"));
        ...
        // spork keys
        consensus.strSporkPubKey = "040aa5891af9bdd184e6828ce18ece2fcf6db9382e0b0f1ab8e27501b98d7e47d2166f55f12586b78ba5c6efc093100140b7fef1131ba893e566d634ff8905f0fc";
        consensus.strSporkPubKeyOld = "040aa5891af9bdd184e6828ce18ece2fcf6db9382e0b0f1ab8e27501b98d7e47d2166f55f12586b78ba5c6efc093100140b7fef1131ba893e566d634ff8905f0fc";
        consensus.nTime_EnforceNewSporkKey = 1;    //!> August 26, 2019 11:00:00 PM GMT
        consensus.nTime_RejectOldSporkKey = 1;     //!> September 26, 2019 11:00:00 PM GMT
        ...
        consensus.vUpgrades[Consensus::UPGRADE_BIP65].nActivationHeight         = 180863000;
        consensus.vUpgrades[Consensus::UPGRADE_ZC_PUBLIC].nActivationHeight     = 168624000;
        consensus.vUpgrades[Consensus::UPGRADE_V3_4].nActivationHeight          = 21;
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 21;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 21;
        consensus.vUpgrades[Consensus::UPGRADE_V5_2].nActivationHeight          = 21;
...
public:
    CRegTestParams()
    {
        ...
        */
        ...
        consensus.vUpgrades[Consensus::UPGRADE_V4_0].nActivationHeight          = 200;
        consensus.vUpgrades[Consensus::UPGRADE_V5_0].nActivationHeight          = 200;
