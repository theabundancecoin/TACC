...
// Copyright (c) 2015-2018 The TaccCoin developers
...
#define QAPP_ORG_NAME "TaccCoin"
#define QAPP_ORG_DOMAIN "pivx.org"
#define QAPP_APP_NAME_DEFAULT "TaccCoin-Qt"
#define QAPP_APP_NAME_TESTNET "TaccCoin-Qt-testnet"
