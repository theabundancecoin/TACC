...
/** Utility functions used by the TaccCoin Qt UI.
 */
namespace GUIUtil
{
...
// Render TaccCoin addresses in monospace font
...
// Parse "tacc:" URI into recipient object, return true on successful parsing
