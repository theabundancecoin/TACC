...
#ifndef TaccCoin_CORE_NEW_GUI_PIVXGUI_H
#define TaccCoin_CORE_NEW_GUI_PIVXGUI_H
...
/**
  tacccoin GUI main class. This class represents the main window of the TaccCoin UI. It communicates with both the client and
...
#endif //TaccCoin_CORE_NEW_GUI_PIVXGUI_H
