...
std::string HelpMessage(HelpMessageMode mode)
{
    ...
    strUsage += HelpMessageOpt("-masternodeaddr=<n>", strprintf(_("Set external address:port to get to this masternode (example: %s)"), "128.127.106.235:38101"));
...
#endif
    LogPrintf("TaccCoin version %s (%s)\n", version_string, CLIENT_DATE);
}
